...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    cron_prompt_placeholder: 'E.g. Show my meetings and unfinished tasks for today',
  ...
  ru: {
    ...
    settings_label_skin: 'Оформление',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    empty_title: 'Здравствуйте, Александр',
    empty_subtitle: 'Спросите что угодно — я помогу.',
    suggest_files: 'Покажи мои файлы',
    suggest_schedule: 'Что у меня сегодня?',
    suggest_plan: 'Помоги спланировать день',
    ...
    cron_prompt_placeholder: 'Например: Покажи мои встречи и невыполненные задачи на сегодня',
    ...
    session_archived: 'Беседа в архиве',
    session_delete: 'Удалить беседу',
    session_delete_desc: 'Удалить эту беседу навсегда',
    session_duplicate: 'Дублировать беседу',
    session_duplicate_desc: 'Создать копию с тем же пространством и моделью',
    session_duplicate_failed: 'Не удалось дублировать: ',
    session_duplicated: 'Беседа скопирована',
    session_move_project: 'Перенести в проект',
    session_move_project_desc_has: 'Сменить проект для этой беседы',
    session_move_project_desc_none: 'Назначить беседе проект',
    session_pin: 'Закрепить беседу',
    session_pin_desc: 'Держать эту беседу наверху списка',
    session_pin_failed: 'Не удалось закрепить: ',
    session_restore: 'Вернуть беседу',
    ...
    settings_heading_subtitle: 'Предпочтения, инструменты беседы и системные элементы.',
    ...
    settings_section_preferences_meta: 'Параметры по умолчанию и поведение интерфейса.',
    settings_section_preferences_title: 'Параметры',
    settings_section_system_meta: 'Версия и управление доступом.',
